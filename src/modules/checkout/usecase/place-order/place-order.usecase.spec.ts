...
describe("Place-order unit test", () =>{
  describe("validate products method", () => {
    ...
    it("should throw error if not products are not selected", async() => {
  ...
  describe("Get products method", () => {
    ...
    it("should be retur a product", async() => {
      const mockCatalogFacade = {
  ...
  });//Fim do describe 'execute method'
});//Fim do describe 'place-order unit test'