...
import CheckOuGateway from "../../gateway/checkout.gateway";
...
export default class PlaceOrderUseCase implements UseCaseInterface{
  ...
  private _repository:CheckOuGateway;
  ...
  async execute(input: PlaceOrderUseCaseInputDto): Promise<PlaceOrderUseCaseOutputDto> {
    ...
    await this._invoiceFacade.generate({
      id:new Id(),
      total:products.reduce((acc, vl) => acc + (vl.quantity + vl.salesPrice),0),
      name:client.name,
